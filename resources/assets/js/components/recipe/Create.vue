...
<script>
    ...
    export default {
        name: "Create",
        components: {
            SetCost, SetCategory, SearchAutocomplete, Ingredients,
            StepsAdd, DropPicturePreview, SetDifficulty,
            SetTimePreparation, SetTimeCooking, SetTimeRest, SetParts, SetVegan, SetComment, SetVideo, SetMedia
        },
        data() {
            return {
                registration: {
